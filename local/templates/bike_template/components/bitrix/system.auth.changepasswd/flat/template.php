...
<?endif?>
		...
		<div class="sub-info">
			<div class="sub-info__text"><?=GetMessage("AUTH_NEW_PASSWORD_REQ")?></div>
...
<?endif?>
				<input type="password" class="input" name="USER_PASSWORD" maxlength="255" value="<?=$arResult["USER_PASSWORD"]?>" autocomplete="new-password" />
                <a class="password-control" href="#"></a>
			</div>
		</div>

		<div class="sub-info">
			<div class="sub-info__text"><?=GetMessage("AUTH_NEW_PASSWORD_CONFIRM")?></div>
			<div class="form-line form-line_pass">
<?if($arResult["SECURE_AUTH"]):?>
...
<?endif?>
				<input type="password" name="USER_CONFIRM_PASSWORD" class="input" maxlength="255" value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>" autocomplete="new-password" />
                <a class="password-control" href="#"></a>
            </div>
		</div>
...
<?endif?>
		...
		<div class="bx-authform-formgroup-container">
			<input type="submit" class="b-button button_fill button_big b-button_submit b-button_avtoriz" name="change_pwd" value="<?=GetMessage("AUTH_CHANGE")?>" />
		</div>
...
<?endif;?>
    <div>
        <a class="lost-pass" name="modal" href="#popup-lk"><?=GetMessage('back_to_login')?></a>
    </div>
