...
<div id="popup-freedate" class="popup-window">
    ...
    <div class="popup-content">
        <div class="popup-title">Free dates for booking</div>
        ...
        <div class="popup-attention">When the date changes, the selected bikes are reset</div>
        <div class="form-line center"><a class="b-button button_fill button_big button_accept">Apply</a></div>
    </div>
</div>