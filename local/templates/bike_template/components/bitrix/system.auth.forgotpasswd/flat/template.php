...
<?endif?>
		...
		<div class="sub-info">
			<div class="sub-info__text"><?echo GetMessage("AUTH_LOGIN_EMAIL")?></div>
			<div class="form-line">
				<input type="text" class="input" name="USER_LOGIN" maxlength="255" value="<?=$arResult["USER_LOGIN"]?>" />
...
<?endif?>
		...
		<div class="bx-authform-formgroup-container">
			<input type="submit" class="b-button button_fill button_big b-button_submit" name="send_account_info" value="<?=GetMessage("AUTH_SEND")?>" />
		</div>

		<div class="bx-authform-link-container">
			<a class="lost-pass" href="<?=$arResult["AUTH_AUTH_URL"]?>"><b><?=GetMessage("AUTH_AUTH")?></b></a>
		</div>
