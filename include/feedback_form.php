<div class="subtitle">Any other questions? Contact us!</div>
<form class="form cont-form">
    <div class="form-line"><input type="text" class="input" name="NAME" required placeholder="Name*" /></div>
    <div class="form-line"><input type="text" class="input masc-phone" name="PHONE" required placeholder="Phone number*" /></div>
    <div class="form-line">
    ...
    <div class="form-line">
        <input type="submit" class="b-button button_fill button_big b-button_submit b-button_form" value="Submit" />
    </div>
</form>